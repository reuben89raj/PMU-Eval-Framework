...
def bus118():
	...
	pmuNetwork = {'P2': ['S1'], 
        ...
        'S2': ['PDC2', 'P12', 'P17', 'P21', 'P24', 'P25', 'P28', 'P114', 'S1', 'S3'],
        'S3': ['PDC3', 'P17', 'P34', 'P37', 'P40', 'P45', 'P49', 'S2', 'S4'],
        'S4': ['PDC4', 'P49', 'P52', 'P56', 'P62', 'P63', 'P68', 'S3', 'S5'],
        'S5': ['PDC5', 'P37', 'P73', 'P75', 'P77', 'P80', 'P85', 'S4', 'S6'],
        'S6': ['PDC6', 'P80', 'P86', 'P90', 'P94', 'P101', 'P105', 'S5', 'S1'],
        'PDC1' : ['S1'],
        'PDC2': ['S2'],
        'PDC3': ['S3'],
        'PDC4': ['S4'],
